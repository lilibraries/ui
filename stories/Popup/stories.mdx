...
<Canvas mdxSource={require("!!raw-loader!./DescriptionContent").default}>
  <Story id="examples-popup--description-content" />
</Canvas>
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `children`        | `string` \| `number` \| `ReactElement` \| [`() => PopperVirtualElement`](?path=/story/overlays-popper--page#poppervirtualelement)                                                          | Trigger element, it should be string, number, a react element (must reference to a DOM element) or a function returns a virtual element.                                                                                                                                                                   |
...
| `onOpened`        | `() => void`                                                                                                                                                                               | The Popup is completely opened, and the open animation is finished.                                                                                                                                                                                                                                        |
| `onClosed`        | `() => void`                                                                                                                                                                               | The Popup is completely closed, and the close animation is finished.                                                                                                                                                                                                                                       |
