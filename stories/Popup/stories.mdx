...
Popup is built on the [Popper](?path=/story/overlays-popper--page) component. It adds simple styles and animation effects. You can use the [`Popper.Config`](?path=/story/overlays-popper--page#popperconfig) to configure the `container` prop of Popup components.
