    ...
    <Direction scoped value="rtl">
      <div>
        <p>
          ...
          companies. React can be used as a base in the development of single-page or mobile applications. However,
        ...
        <Direction scoped value="ltr">
          <p>
            ...
            applications. However, React is only concerned with state management and rendering that state to the DOM, so
            creating React applications usually requires the use of additional libraries for routing, as well as certain
