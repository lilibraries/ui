    ...
    <Table
      ...
      body={[
        [
          ...
          <Value styleName="fontWeight" styleValue={`var(--${prefix}font-weight-base)`} />,
          <span style={{ fontWeight: `var(--${prefix}font-weight-base` }}>Base</span>,
        ],
        ...
        [
          ...
          <span style={{ fontWeight: `var(--${prefix}font-weight-heading` }}>Heading</span>,
        ],

        [
          <Usage type="scss" name="font-weight-title" />,
          <Usage type="css" name="font-weight-title" />,
          <Value styleName="fontWeight" styleValue={`var(--${prefix}font-weight-title)`} />,
          <span style={{ fontWeight: `var(--${prefix}font-weight-title` }}>Title</span>,
        ],

        [
          <Usage type="scss" name="font-weight-subtitle" />,
          <Usage type="css" name="font-weight-subtitle" />,
          <Value styleName="fontWeight" styleValue={`var(--${prefix}font-weight-subtitle)`} />,
          <span style={{ fontWeight: `var(--${prefix}font-weight-subtitle` }}>Subtitle</span>,
        ],
      ]}
    />
  );
