    ...
    <Table
      ...
      body={[
        [
          ...
          <Value styleName="animationDuration" styleValue={(prefix) => `var(--${prefix}motion-duration-base)`} />,
        ],

        [
          <Usage type="scss" name="motion-duration-fast" />,
          <Usage type="css" name="motion-duration-fast" />,
          <Value styleName="animationDuration" styleValue={(prefix) => `var(--${prefix}motion-duration-fast)`} />,
        ],

        [
          <Usage type="scss" name="motion-duration-slow" />,
          <Usage type="css" name="motion-duration-slow" />,
          <Value styleName="animationDuration" styleValue={(prefix) => `var(--${prefix}motion-duration-slow)`} />,
        ],

        [
          <Usage type="scss" name="motion-duration-lazy" />,
          <Usage type="css" name="motion-duration-lazy" />,
          <Value styleName="animationDuration" styleValue={(prefix) => `var(--${prefix}motion-duration-lazy)`} />,
        ],
      ]}
    />
  );
