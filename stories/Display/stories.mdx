...
This component can delay displaying and hiding content. It is very useful when creating CSS animation components, such as the [Transition](?path=/story/animations-transition--page) component.
