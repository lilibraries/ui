...
You can specify an React element for the `trigger` prop that accepts the `onClick` event, and the opening of the Modal can be controlled by the specified element.

<Canvas mdxSource={require("!!raw-loader!./TriggerButton").default}>
  <Story id="examples-modal--trigger-button" />
</Canvas>
...
The Modal component has three preset widths: `"small"`, `"medium"`, `"large"`. You can also customize the width.
...
| `width`        | `"small"` \| `"medium"` \| `"large"` \| `string` \| `number`                                | Preset width or custom width.                                                                                                                                                                                                                                                                         |
...
| `trigger`      | `ReactElement`                                                                              | Trigger element for opening modal. It should accept the `onClick` prop.                                                                                                                                                                                                                               |
