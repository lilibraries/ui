...
You can close the backdrop by pressing the <kbd>ESC</kbd> key, hidding the page, losing focus on the window, or clicking the backdrop.
...
| `closeOnBackdropClick` | `boolean`                                                                                   | Close when clicking backdrop, default is `true`                                                                                                                                                                                                                                                         |
