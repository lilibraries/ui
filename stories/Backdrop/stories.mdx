...
<Canvas mdxSource={require("!!raw-loader!./Animeless").default}>
  <Story id="examples-backdrop--animeless" />
</Canvas>
...
You can close the backdrop by pressing the <kbd>ESC</kbd> key, hidding the page, losing focus of the window, or clicking the backdrop.
