...
| `onClose`     | `() => void`                                                                                | Close event. Start executing close animation.                                                                                                                                                                                                                                                            |
| `onOpened`    | `() => void`                                                                                | Opened event. The Backdrop is opened, and the open animation is finished.                                                                                                                                                                                                                                |
| `onClosed`    | `() => void`                                                                                | Closed event. The Backdrop is closed, and the close animation is finished.                                                                                                                                                                                                                               |
| `onDisplayed` | `() => void`                                                                                | Displayed event. The Backdrop has been displayed, and starts executing the open animation.                                                                                                                                                                                                               |
