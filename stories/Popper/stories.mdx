...
Popper is built on [floating-ui](https://floating-ui.com/), and it's the base component of pop-up components in this library, such as Popover, Tooltip, Confirm, Dropdown. You can build your own pop-up components based on this component.
